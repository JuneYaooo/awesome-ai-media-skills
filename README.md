...
| [hermes-tweet](https://github.com/Xquik-dev/hermes-tweet) | Hermes Agent | ⭐ B | 🟢 Active | ![](https://img.shields.io/github/stars/Xquik-dev/hermes-tweet?style=flat-square) | Native Hermes Agent plugin for Twitter/X search, profile and timeline reads, reply/thread lookup, and guarded action tools. Ships PyPI packaging, plugin manifests, SKILL.md, and compatibility tests. |
